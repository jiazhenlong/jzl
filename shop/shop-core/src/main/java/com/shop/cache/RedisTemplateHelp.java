...
/**  
*
* @Title:  RedisTemplateHelp.java   
* @Package com.shop.cache   
* @Description:    TODO(redis服务类)   
* @author: jiazhenlong     
* @date:   2018年5月29日 上午11:01:06   
* @version V1.0 
* @Copyright: 2018 wehere All rights reserved. 
*/
@Service
public class RedisTemplateHelp {

  private static final Logger LOG = LoggerFactory.getLogger(RedisTemplateHelp.class);
  ...
  public <T> boolean set(String key,
    ...
    try {
      if (time > 0) {
        redisTemplate.opsForValue().set(key,
                JSON.toJSONString(value, SerializerFeature.WriteClassName), time, TimeUnit.SECONDS);
      } else {
        set(key, value);
      }
      return true;
